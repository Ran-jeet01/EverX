...
<template>
  <div class="page-container container pt-[calc(var(--header-height)+2rem)]">
    ...
    <div v-if="loading" class="text-center py-16 text-lg text-slate-500">Loading products...</div>

    <div v-else class="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-8 pb-16">
      <ProductCard
